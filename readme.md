...
2.  **Dataset Metadata**, accessible in companion website (<https://warwickcim.github.io/rdf_mastodon_data/>) and a machine-readable JSON file (<https://osf.io/efm7j>), both generated with [dataspice](https://docs.ropensci.org/dataspice/).
